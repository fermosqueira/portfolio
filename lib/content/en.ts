...
export const en = {
  ...
  projects: {
    ...
    items: {
      aiQa: {
        title: "AI-assisted test design, reviewed case by case",
        body: "Two user stories, 22 test cases generated by an AI assistant, and a written verdict on every one — kept, fixed or rejected, with the reason. 15 made it into the Playwright suite. Four are marked as expected failures, because running them found real defects in the application under test: a negative amount runs the transfer backwards, and the amount field accepts cents that the app then silently drops. The point is not that AI wrote the tests. It is that the review is written down and anyone can check it.",
      },
      e2e: {
